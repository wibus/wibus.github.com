...
\title{Curriculum vitea -- William Bussière}
...
\cventry{2015~--~2017}{Maîtrise en génie informatique}{Polytechnique Montréal}{
	...
	Nomitation pour le meilleur mémoire de l'année
}

\cventry{2010~--~2015}{Baccalauréat en génie logiciel}{Polytechnique Montréal}{
	Moyenne cummulative~: 3,93/4\\
...
\cventry{2013~--~2014}{Directeur technique pour MÉTIS}{Polytechnique Montréal}{
	...
	Diriger l’équipe logiciel au sein d’un projet étudiant multidisciplinaire\\
	Communiquer l'avancement du travail au conseil d'adaministration hebdomadairement\\
	Évaluer et sélectionner des technologies pour la réalisation du projet\\
	Documentater des solutions choisies et des procédures d’installation\\
}
...
\cventry{2012~--~2013}{Stage en développement logiciel}{Zimmer CAS}{
	...
	Valider des librairies tiers et documenter les applications développées\\
...
\cventry{2011~--~2016}{Conception d'un moteur de simulations}{Projet personnel}{
	...
	$\bullet$ \textit{Prop Room 3D}~: Framework de rendu par path tracing en parallèle et distributé sur CPU\\
...
\cventry{Printemps\\2015}{Développement d'un jeu vidéo pour Laval Virtual}{Projet intégrateur}{
	...
	Les compagnons ennemis ajoutes des obstacles pour freiner le coureur\\
...
\cventry{Hiver 2015}{Bourse de Polyechnique}{}{
