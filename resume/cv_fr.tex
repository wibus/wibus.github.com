...
\cventry{2015~--~2017}{Maîtrise recherche en génie informatique}{Polytechnique Montréal}{
    ...
    En nomitation pour le meilleur mémoire de l'année%\\\\
    Disponible à~: \href{https://github.com/wibus/GpuMesh}{github.com/wibus/GpuMesh}
}
...
\cvplaincontent{
    \textit{\textbf{Bussière, W.}, Guibault, F. (2017) Hybrid CPU/GPU parallel unstructured mesh adaptation. 14th U.S. National Congress on Computational Mechanics.} (Conception des tests, génération des résultats et production de figures)
}
...
\cventry{Novembre 2017}{Développeur logiciel de rendu AR/VR}{Autodesk}{
    Développement d'un engin de visualisation architecturalle en réalité virtuelle/augmentée\\
    Implémenter des lumières en boîtes pour les plateformes utilisant OpenGL\\
...
\cventry{Printemps\\2015}{Développement d'un jeu vidéo pour Laval Virtual}{Projet académique}{
...
\cventry{Printemps\\2012 et 2014}{Développement d'un jeu de hockey sur coussin d'air}{Projet académique}{
...
\cventry{Printemps\\2011}{Assemblage et programmation d'un robot}{Projet académique}{
