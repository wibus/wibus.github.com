...
\cvplaincontent{	
	...
	\textbf{CG Techniques}~: path tracing, radiosity, volume rendering, shadow mapping
}
...
\cventry{2015~--~2017}{Master of Computer Engineering}{Polytechnique Montréal}{
	Parallel mesh adaptation on the CPU and GPU\\
	Nominated for best master's thesis of the year\\
    Available at: \href{https://github.com/wibus/GpuMesh}{github.com/wibus/GpuMesh}
}
...
\cvplaincontent{
    \textit{\textbf{Bussière, W.}, Guibault, F. (2017) Hybrid CPU/GPU parallel unstructured mesh adaptation. 14th U.S. National Congress on Computational Mechanics.} (tests design, results generation and tables and figures edition)
}
...
\cventry{Novembre 2017}{Software Dev. Realtime AR/VR Rendering}{Autodesk}{
    Architectural visualization real time renderer for AR/VR devices\\
    Translate box lights shaders for OpenGL platforms\\
    Optimize local lights access for light baking on the GPU\\
...
\cventry{Summer 2014}{Software Engineering Internship}{Dental Wings}{
	Intraoral scanning station for digital dental impressions\\
	Implement a shadow mapping engine in OpenGL/GLSL\\
...
\cventry{2015~--~2016}{Short Animated Film}{Personal project}{
    \textit{The Fruit -- A Moving Picture}~: \href{https://www.youtube.com/watch?v=VjX9oaAhz5A&t=43s}{www.youtube.com}\\
    Animation, rendering and post-production software designed exclusively for this animation\\
    The system renders the images using a progressive multi-threaded and distributed path tracer\\
    ...
    The scene contains zero triangles; every object is the result of Boolean operations on quadrics (planes, spheres, paraboloids, hyperboloids, etc.)
}

\cventry{2011~--~2016}{Simulation Library}{Personal project}{
    \textit{Experiemental Theatre} is a  C++ library regrouping the four following modules:\\
    $\bullet$ \textit{Cellar Workbech}~: Data structures, generic design patterns, logging, geometric primitives, resource management,  OpenGL wrapper classes, string utility functions, etc.\\
    ...
    Available at: \href{http://www.github.com/wibus/ExperimentalTheatre}{github.com/wibus/ExperimentalTheatre}
}
...
\cventry{Spring\\2015}{Kinect Game for Laval Virtual}{Academic project}{
    ...
    Enemies try to stop the runner by dropping bombs and obstacles on his path\\
...
\cventry{Spring\\2011}{ATMega16 Robot Obstacle Course}{Academic project}{
    ...
    Setup the motherboard for an ATMega16 microcontroller and an H-bridge circuit\\
    Design interfaces for a magnetic captor, an infrared captor and an external memory\\
...
\cventry{Winter 2015}{Polytechnique Scholarship}{}{
    Excellence of Bachelor's academic record
}
...
\cventry{Fall 2010}{General Director's Scholarship}{}{
	Excellence of CÉGEP academic record
}
...
\cvplaincontent{
    Olivier Dionne, \textit{Software Dev. Manager at Autodesk}~: olivier.dionne@autodesk.com \\
